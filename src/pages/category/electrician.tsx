					...
					<div className="mx-10 md:mx-40">
						<div className="text-center">
							...
							<h3 className="text-xl my-2">
								These are are aavailable electricians in your area ou sshould
								make a select and cantact them for thier service
							</h3>
						</div>
