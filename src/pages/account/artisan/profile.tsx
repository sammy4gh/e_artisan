...
export const Profile = ({image_url}) => {
    return (
			<section
				className={
					"h-screen md:bg-login-wave bg-no-repeat bg-cover bg-center bg-fixed flex justify-center justify-items-center px-10 "
				}
			>
				<div
					className={
						"h-full md:h-4/5 flex grid grid-cols-2 gap-8  justify-around m-auto md:bg-gray-50  md:shadow-lg md:rounded-lg md:py-6 md:px-10 md:w-3/4 lg:w-3/4"
					}
				>
					<div
						id={
							"artisan-info flex flex-col justify-around gap-4 bg-white rounded-lg "
						}
					>
